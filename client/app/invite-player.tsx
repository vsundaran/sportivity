      ...
      setUsers(
        players.map((player: any) => ({
          ...
          isSelected: selectedPlayers.some(
            (selected: User) => selected._id === player._id
          ),
        }))
      );
    }
      ...
      <View style={styles.tabsContainer}>
        ...
        >
          <Text
            style={[
              styles.tabText,
              activeTab === "RECENTLY PLAYED" && styles.activeTabText,
            ]}
          >
            RECENTLY PLAYED
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.tab,
            activeTab === "DISCOVER PLAYERS" && styles.activeTab,
          ]}
        ...
        >
          <Text
            style={[
              styles.tabText,
              activeTab === "DISCOVER PLAYERS" && styles.activeTabText,
            ]}
          >
            DISCOVER PLAYERS
          </Text>
        ...
        {isLoading && !users.length ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyStateText}>
              Search players to get the list of users
            </Text>
          </View>
        )}
      </ScrollView>
